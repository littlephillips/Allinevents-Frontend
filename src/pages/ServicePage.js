...
{/* 
                    ...
                    <div class="md: flex flex-col items-center p-2 right-0">                        
                        ...
                        <button onClick={e => handleClick(service.eventname)} style={{marginTop: "10px", }} class="opacity-75 bg-gray-300 hover:bg-pink-900 hover:text-white text-sm font-bold py-2.5 px-4 rounded inline-flex items-center">
