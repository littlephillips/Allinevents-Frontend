    ...
    return (
                <>
                    <div class="shadow-sm min-h-min w-screen p-6 flex flex-col text-center bg-[#f1f1ef]">
                        ...
                        <p className='font-secondary text-xl p-2'>
                            AllEvents is the one place stop for planning your dream celebrations.
                            <br/>
                            Hire us to manage your upcoming event!
                        </p>
                        <br/>  <hr />     <br />

                        <h2 className='text-center font-bold font-primary p-4  text-2xl shadow-sm '>Our Team</h2>
                            <br/>
            ...
            {/* Team Lead */}
                        <div class="max-w-sm p-2 bg-white border border-gray-200 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
                            <Link to="/contact">
                                <img class="rounded-t-lg" src={'https://avataaars.io/?avatarStyle=Circle&topType=ShortHairDreads01&accessoriesType=Wayfarers&hairColor=Black&facialHairType=Blank&clotheType=Hoodie&clotheColor=Red&eyeType=Wink&eyebrowType=FlatNatural&mouthType=Smile&skinColor=DarkBrown'} alt="Phillip Kinuthia" />
                            </Link>
                            <div class="p-5">
                                <Link to="/contact">
            ...
            {/* Team manager */}
                        <div class="max-w-sm p-2 bg-white border border-gray-200 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
                            <Link to="/contact">
                                <img class="rounded-t-lg" src={'https://avataaars.io/?avatarStyle=Circle&topType=Hijab&accessoriesType=Prescription02&hatColor=PastelYellow&clotheType=GraphicShirt&clotheColor=PastelOrange&graphicType=SkullOutline&eyeType=Side&eyebrowType=UnibrowNatural&mouthType=Default&skinColor=Brown'} alt="Isir Malak" />
                            </Link>
                            <div class="p-5">
                                <Link to="/contact">
            ...
            {/* Media Team */}
                        <div class="max-w-sm p-2 bg-white border border-gray-200 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
                            <Link to="/contact">
                                <img class="rounded-t-lg" src={'https://avataaars.io/?avatarStyle=Circle&topType=ShortHairShortCurly&accessoriesType=Sunglasses&hairColor=Black&facialHairType=BeardLight&facialHairColor=Black&clotheType=BlazerShirt&eyeType=Happy&eyebrowType=RaisedExcited&mouthType=Smile&skinColor=Black'} alt="Stephen Kago" />
                            </Link>
                            <div class="p-5">
                                <Link to="/contact">
            ...
            {/* Team Marketer */}
                        <div class="max-w-sm p-2 bg-white border border-gray-200 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
                        <Link to="/contact">
                            <img class="rounded-t-lg" src={'https://avataaars.io/?avatarStyle=Circle&topType=ShortHairTheCaesarSidePart&accessoriesType=Prescription02&hairColor=Black&facialHairType=Blank&clotheType=Hoodie&clotheColor=Black&eyeType=Default&eyebrowType=RaisedExcited&mouthType=Smile&skinColor=DarkBrown'} alt="Wycliffe Ndung'u" />
                        </Link>
                        <div class="p-5">
                            <Link to="/contact">
            ...
            {/* Team Manager */}
                        <div class="max-w-sm p-2 bg-white border border-gray-200 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
                        <Link to="/contact">
                            <img class="rounded-t-lg" src={'https://avataaars.io/?avatarStyle=Circle&topType=LongHairBun&accessoriesType=Prescription02&hairColor=Blonde&facialHairType=Blank&clotheType=Hoodie&clotheColor=White&eyeType=Close&eyebrowType=RaisedExcited&mouthType=Smile&skinColor=Tanned'} alt="Silvia Wachira" />
                        </Link>
                        <div class="p-5">
                            <Link to="/contact">
